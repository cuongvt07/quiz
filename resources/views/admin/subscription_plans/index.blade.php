...
<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-2 mb-4">
    <h1 class="text-2xl font-bold flex items-center gap-2"><i data-feather="dollar-sign"></i> Gói nâng cấp thành viên</h1>
</div>
<x-admin.filter>
...
@endif
<x-admin.table :headers="['#', 'Tên gói', 'Giá (VNĐ)', 'Số ngày', 'Mô tả', 'Hành động']">
    {{-- Form tạo mới --}}
        ...
        <tr class="border-b bg-yellow-50">
            <form action="{{ route('admin.subscription_plans.update', $plan) }}" method="POST" class="contents">
                ...
                <td class="px-3 py-2 flex gap-2 justify-end">
                    ...
                    <a href="{{ route('admin.subscription_plans.index', request()->except('edit')) }}" class="p-2 rounded hover:bg-gray-100 text-gray-500" title="Huỷ"><i data-feather="x" style="width:20px;height:20px"></i></a>
                </td>
            </form>
        </tr>
        @else
